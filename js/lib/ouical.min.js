;(function (e) {
    ...
    var i = {
        google: function (e) {
            ...
            return '<a class="icon-google" target="_blank" href="' + s + '"><span style="margin-right: 10px;">Google Calendar</span></a>'
        }, yahoo: function (e) {
            ...
            return '<a class="icon-yahoo" target="_blank" href="' + a + '"><span style="margin-right: 10px;">Yahoo! Calendar</span></a>'
        }, ics: function (e, t, i) {
            var s = n(e.start);
            var o = r(e);
            ...
            return '<a class="' + t + '" target="_blank" href="' + u + '"><span style="margin-right: 10px;">' + i + " Calendar</span></a>"
        }, ical: function (e) {
    ...
    var f = function (e, t, n) {
        ...
        r.innerHTML = '<span for="checkbox-for-' + n + '" class="add-to-calendar-checkbox"></span>';
